  ...
  return (
    ...
    <div className="d-flex flex-column flex-lg-row justify-content-between px-5 align-items-center w-100"
      ...
      <div className="d-flex flex-row text-center icon_wrapper py-3 py-lg-1">
        <Link href={"#"}><img src="/fb.png" className="mx-2 border-radious-50" alt="" /></Link>
        <Link href={"#"}><img src="/insta.png" className="mx-2 border-radious-50" alt="" /></Link>
        <Link href={"#"}><img src="/email.png" className="mx-2 border-radious-50" alt="" /></Link>
        <Link href={"#"}><img src="/twitter.png" className="mx-2 border-radious-50" alt="" /></Link>
      </div>
